...
critText = False
icebY = 1000
monster = pygame.image.load("/USers/jeppe/Visual Studio/Pygame/BattleOn/BattleOn/monster.png")
desert = pygame.image.load("/USers/jeppe/Visual Studio/Pygame/BattleOn/BattleOn/desert.jpg")
mand = pygame.image.load("/USers/jeppe/Visual Studio/Pygame/BattleOn/BattleOn/mand.png")
svaerd = pygame.image.load("/USers/jeppe/Visual Studio/Pygame/BattleOn/BattleOn/svaerd.png")
lightning = pygame.image.load("/USers/jeppe/Visual Studio/Pygame/BattleOn/BattleOn/lightning.png")
fireball = pygame.image.load("/USers/jeppe/Visual Studio/Pygame/BattleOn/BattleOn/fireball.png")
wizard = pygame.image.load("/USers/jeppe/Visual Studio/Pygame/BattleOn/BattleOn/wizard.png")
iceb = pygame.image.load("/USers/jeppe/Visual Studio/Pygame/BattleOn/BattleOn/iceb.png")
roundStart = True
run = True
while run:
    if roundStart:
